function h = reconstruction3d_HArtMuT(cortex, data, varargin)
...
axes(options.axes)
cla
h = trisurf(cortex.faces +1 , cortex.vertices(:,1),cortex.vertices(:,2),cortex.vertices(:,3),'FaceVertexCData',vca,'FaceColor','interp');
% h = patch('Faces', 1+cortex.faces, 'Vertices', cortex.vertices,'FaceVertexCData',vca,'FaceColor','interp');
